...
export class ApplicationHttpClient {
  ...
  public _urlAPI = environment.urlServiceSSO;
  public _urlAPIEnterprise = environment.urlEnterpriseService +'/etp';
  public _urlAPIEnterpriseCommon = environment.urlEnterpriseService;
  public _urlAuthenticationService = environment.urlServiceSSO;
